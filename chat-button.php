...
function amin_chat_button_settings_page() {
    ...
    if (isset($_POST['amin_chat_button_plugin_submit'])) {
        ...
        update_option('amin_chat_button_plugin_phone_en', sanitize_text_field($_POST['amin_chat_button_plugin_phone_en']));
        update_option('amin_chat_button_plugin_phone_tr', sanitize_text_field($_POST['amin_chat_button_plugin_phone_tr']));
        ...
        update_option('amin_chat_button_plugin_text_en', sanitize_text_field($_POST['amin_chat_button_plugin_text_en']));
        update_option('amin_chat_button_plugin_text_en_loc', sanitize_text_field($_POST['amin_chat_button_plugin_text_en_loc']));
        update_option('amin_chat_button_plugin_text_tr', sanitize_text_field($_POST['amin_chat_button_plugin_text_tr']));
        update_option('amin_chat_button_plugin_text_tr_loc', sanitize_text_field($_POST['amin_chat_button_plugin_text_tr_loc']));
    ...
    if ($msg_select == 'WhatsApp') {
        ...
        if (!empty($matches[1])) {
            ...
            switch ($locale) {
                ...
                default:
                    break;
                // Дополнительные языки могут быть добавлены по необходимости
                // Не нужен default блок, так как $link уже содержит значение по умолчанию
            }
        }
